...
<?php
	...
	echo " <table class='table'>";
		    echo"<tbody >"; 
      		echo "<tr >";
			echo"<td>"; ?> <img src="<?php echo $row['image'];  ?>" height="200" alt="<?php echo $row['Model_Name'] ?>" width="300	" <?php echo "</td>";       	
			echo "<td>";
			...
			echo "</td>";
			echo "<td>"."<a href=loginForm.php><h5></h5><img src=images/book.png height=65 width=100/></td>";
      		echo "</tr>";
